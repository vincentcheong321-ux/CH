...
export const DRAW_DATES: Record<number, { w: number[], s1: number[], s2: number[], t: number[] }> = {
  ...
  11: { w: [3,10,17,24,31], s1: [6,13,20,27,34], s2: [7,14,21,28,35], t: [32] }, // DEC (32=Jan1, 34=Jan3, 35=Jan4)
};

// 2026 Configuration
export const DRAW_DATES_2026: Record<number, { w: number[], s1: number[], s2: number[], t: number[] }> = {
  0: { w: [7,14,21,28], s1: [10,17,24,31], s2: [11,18,25,32], t: [27] }, // JAN (3,4 removed as they belong to Dec '25. 1 removed. 27=Tue, 32=Feb1)
